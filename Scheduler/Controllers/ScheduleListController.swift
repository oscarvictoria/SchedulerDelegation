...
class ScheduleListController: UIViewController {
    ...
    private func showEventVC(_ event: Event? = nil) {
        // we need to use the storyboard to get an instance of the create event controller
        ...
        // Pushes new view controller
        present(createEventController, animated: true)
        
        // TODO: For updating an event we will inject the selected event
        // that means an event was passed in to this function
